...
class TicketActionsScenario extends StatefulWidget {
  ...
  @override
  State<TicketActionsScenario> createState() => TicketActionsScenarioState();
}

class TicketActionsScenarioState
    extends ExpandableSceneState<TicketActionsScenario> {
  @override
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          const ShowcaseBadge(label: 'SLA مرتفع'),
                        ],
                      ),
