...
const englishUnifiedShowcaseStrings = UnifiedShowcaseStrings(
  ...
  searchResultPrimaryTitle: 'Maya Hassan',
  searchResultPrimarySubtitle: 'Lab review + care note',
  searchResultSecondaryTitle: 'Noor Salem',
...
const arabicUnifiedShowcaseStrings = UnifiedShowcaseStrings(
  ...
  searchResultPrimaryTitle: 'مايا حسن',
  ...
  dayPanelPrimaryTime: '09:15',
  dayPanelPrimaryDetail: 'مايا حسن · مراجعة الجرح',
  dayPanelSecondaryTime: '11:00',
  dayPanelSecondaryDetail: 'نور سالم · متابعة الدواء',
  dayPanelTertiaryTime: '14:30',
  ...
  activityMessageSubtitle:
      'وصلت نتيجة المختبر. يمكن لمايا المغادرة بعد ملاحظة 11:00.',
  ...
  localeEnglishLabel: 'English',
  localeArabicLabel: 'العربية',
  defaultDraftText: 'اتصل بمايا بعد مراجعة المختبر وأكد متابعة يوم الخميس.',
);
