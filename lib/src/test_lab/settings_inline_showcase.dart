...
class _SettingsInlineDetailExperience extends StatefulWidget {
  const _SettingsInlineDetailExperience();

  @override
  State<_SettingsInlineDetailExperience> createState() =>
      _SettingsInlineDetailExperienceState();
}

class _SettingsInlineDetailExperienceState
    extends State<_SettingsInlineDetailExperience> {
  final _sceneKey = GlobalKey<_SettingsInlineScenarioState>();
...
class _SettingsInlineScenario extends StatefulWidget {
  const _SettingsInlineScenario({
    super.key,
  ...
  @override
  State<_SettingsInlineScenario> createState() =>
      _SettingsInlineScenarioState();
}

class _SettingsInlineScenarioState
    extends _ExpandableSceneState<_SettingsInlineScenario> {
  @override
  Widget build(BuildContext context) {
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          const _Badge(label: 'الحساب الشخصي'),
                        ],
                      ),
  ...
  Widget build(BuildContext context) {
    return _SurfaceScrollableContent(
      children: [
        ...
        const SizedBox(height: 12),
        _InfoRow(label: 'الوضع الحالي', value: detailText),
        const SizedBox(height: 8),
        _InfoRow(label: 'وقت الإرسال', value: scheduleText),
      ],
    );
  }
}
