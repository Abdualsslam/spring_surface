...
class _FilterChipButton extends StatelessWidget {
  const _FilterChipButton({required this.label, required this.accent});
...
class _SearchFieldTrigger extends StatelessWidget {
  const _SearchFieldTrigger({
    required this.text,
    required this.accent,
    this.expanded = false,
  });
...
class _BookingSlotButton extends StatelessWidget {
  const _BookingSlotButton({
    required this.time,
    required this.title,
    required this.accent,
  });
...
class _SettingsRowTrigger extends StatelessWidget {
  const _SettingsRowTrigger({
    required this.label,
    required this.value,
    required this.accent,
  });
...
class _ComposerBar extends StatelessWidget {
  const _ComposerBar({required this.placeholder, required this.accent});
...
class _CheckoutDockBar extends StatelessWidget {
  const _CheckoutDockBar({
    required this.total,
    required this.accent,
...
class _CalendarSlotGhost extends StatelessWidget {
  const _CalendarSlotGhost({
    required this.time,
    required this.detail,
...
class _SettingsRowGhost extends StatelessWidget {
  const _SettingsRowGhost({required this.label, required this.value});
